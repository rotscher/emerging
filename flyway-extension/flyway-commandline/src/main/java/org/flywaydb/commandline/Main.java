...
public class Main {
     ...
     * @throws java.io.IOException When the jars could not be loaded.
     */
     ...
     * @throws java.io.IOException when the jar or directory could not be found.
     */
    /* private -> for testing */
    ...
    private static String getInstallationDir() {
        ...
        return path.substring(0, path.lastIndexOf("/")) + "/src/main";
    }
